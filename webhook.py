"""
webhook.py — Pure forwarding webhook for the restaurant scraping agent.
Receives triggers from Airtable and forwards them to the Manus agent.

Environment variables required:
  MANUS_URL  — Public URL of the Manus webhook server e.g. https://8000-xxx.manus.app
"""
...
@app.get("/")
def health():
    return {"status": "online", "service": "Restaurant Webhook"}
